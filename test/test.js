...
//     expect(result.spectra[0].data.y.length).toEqual(Number(result.info.$SI));
//     expect(result.spectra[1].data.y.length).toEqual(Number(result.info.$SI));
...
//     let len = result.spectra[0].nbPoints;
...
//     expect(result.spectra[0].data.x.slice(0, 5)).toEqual([
//       0,
//       0.00004839999999999998,
//       0.00009679999999999995,
//       0.00014519999999999992,
//       0.0001935999999999999,
//     ]);
...
//     expect(result.spectra[1023].data.y).toHaveLength(
//       Number(result.info.$SI[0]),
//     );
...
describe('Test with zip file', function () {
  ...
  //   expect(result[0].value.spectra[0].data.x.length).toBe(65536);
...
//     expect(result[0].value.spectra[0].lastX).toEqual(2.726297600000002);

//     expect(result[1].value.spectra[0].firstX).toEqual(0);
//     expect(result[1].value.spectra[0].lastX).toEqual(2.726297600000002);
//   });
// });
